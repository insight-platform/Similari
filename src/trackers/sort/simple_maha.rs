...
///
pub struct SORT {
    store: TrackStore<SortAttributes, MahaSortMetric, GenericBBox>,
    epoch: Arc<RwLock<HashMap<u64, usize>>>,
}

impl From<Track<SortAttributes, MahaSortMetric, GenericBBox>> for SortTrack {
    fn from(track: Track<SortAttributes, MahaSortMetric, GenericBBox>) -> Self {
...
impl SORT {
    ...
    ///
    pub fn wasted(&mut self) -> Vec<Track<SortAttributes, MahaSortMetric, GenericBBox>> {
